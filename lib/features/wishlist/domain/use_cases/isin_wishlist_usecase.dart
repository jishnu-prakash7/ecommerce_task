...
class IsinWishlistUsecase implements UseCase<DataState<void>, num> {
  final WishlistRepository _wishlistRepository;
  IsinWishlistUsecase(this._wishlistRepository);
  @override
  Future<DataState<bool>> call({required num params}) async {
    return await _wishlistRepository.isInWishlist(productId: params);
  }
}
